...
export default function SideBarContent() {
  return (
    <ul className="flex flex-col gap-2">
      ...
      <li className="h-10">
        <Link to="/events" className="flex items-center h-full w-full">
          03. Events
        </Link>
      </li>

      <li className="h-10">
        <Link to="/timetable" className="flex items-center h-full w-full">
          04. Time Table
        </Link>
      </li>
      ...
      <li className="h-10">
        <Link to="/committee" className="flex items-center h-full w-full">
          06. Committee
        </Link>
      </li>
    </ul>
